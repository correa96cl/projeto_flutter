...
import 'package:projeto_flutter/styles/palette_dark.dart';
import 'package:projeto_flutter/styles/palette_light.dart';
...
class MyTheme {
  ...
  static final ThemeData escuro = ThemeData.dark().copyWith(
      ...
      switchTheme:
          SwitchThemeData(thumbColor: MaterialStateColor.resolveWith((states) {
        return states.contains(MaterialState.selected)
            ? _dark.primary
            : _dark.secondary;
      }), trackColor: MaterialStateColor.resolveWith((states) {
